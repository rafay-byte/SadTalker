# this scripts installs necessary requirements and launches main program in streamlit
# adapted from the original gradio launcher
import subprocess
import os
import sys
...
def prepare_environment():
    ...
    if not is_installed("streamlit"):
        run_pip("install streamlit", "Streamlit for SadTalker WebUI")

    run_pip(f"install -r \"{requirements_file}\"",
...
def start():
    print(f"Launching SadTalker Streamlit Web UI")

    # Get command line arguments for streamlit
    ...
    try:
        ...
        print("\nShutting down SadTalker Streamlit Web UI")
